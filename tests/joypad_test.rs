...
mod joypad_tests {
    ...
    fn test_joypad_basic_operations() {
        ...
        cpu.ram.write(0xFF00, 0x20);
        let val = cpu.ram.read(0xFF00);
    ...
    fn test_joypad_multiple_buttons() {
        ...
        cpu.ram.joypad.press("UP");
        cpu.ram.joypad.press("RIGHT");

        cpu.ram.write(0xFF00, 0x20); // seleciona D-pad (bit 4=0)
        let val = cpu.ram.read(0xFF00);
    ...
    fn test_joypad_mode_switching() {
        ...
        cpu.ram.joypad.press("DOWN");  // D-pad
        cpu.ram.joypad.press("B");     // Ação

        // Lê D-pad: bit 4=0, bit 5=1 → 0x20
        cpu.ram.write(0xFF00, 0x20);
        let dpad = cpu.ram.read(0xFF00);
        ...
        cpu.ram.write(0xFF00, 0x10);
        let action = cpu.ram.read(0xFF00);
