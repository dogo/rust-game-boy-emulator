...
// === INC r ===
const INC_B_PROGRAM: MicroProgram = MicroProgram::new(0x04, "INC B", &[MicroAction::IncReg { reg: Reg8::B }]);
const INC_C_PROGRAM: MicroProgram = MicroProgram::new(0x0C, "INC C", &[MicroAction::IncReg { reg: Reg8::C }]);
const INC_D_PROGRAM: MicroProgram = MicroProgram::new(0x14, "INC D", &[MicroAction::IncReg { reg: Reg8::D }]);
const INC_E_PROGRAM: MicroProgram = MicroProgram::new(0x1C, "INC E", &[MicroAction::IncReg { reg: Reg8::E }]);
const INC_H_PROGRAM: MicroProgram = MicroProgram::new(0x24, "INC H", &[MicroAction::IncReg { reg: Reg8::H }]);
const INC_L_PROGRAM: MicroProgram = MicroProgram::new(0x2C, "INC L", &[MicroAction::IncReg { reg: Reg8::L }]);
const INC_A_PROGRAM: MicroProgram = MicroProgram::new(0x3C, "INC A", &[MicroAction::IncReg { reg: Reg8::A }]);

const INC_HL_PROGRAM: MicroProgram = MicroProgram::new(0x34, "INC (HL)", &[MicroAction::IncHlValue]);

// === DEC r ===
const DEC_B_PROGRAM: MicroProgram = MicroProgram::new(0x05, "DEC B", &[MicroAction::DecReg { reg: Reg8::B }]);
const DEC_C_PROGRAM: MicroProgram = MicroProgram::new(0x0D, "DEC C", &[MicroAction::DecReg { reg: Reg8::C }]);
const DEC_D_PROGRAM: MicroProgram = MicroProgram::new(0x15, "DEC D", &[MicroAction::DecReg { reg: Reg8::D }]);
const DEC_E_PROGRAM: MicroProgram = MicroProgram::new(0x1D, "DEC E", &[MicroAction::DecReg { reg: Reg8::E }]);
const DEC_H_PROGRAM: MicroProgram = MicroProgram::new(0x25, "DEC H", &[MicroAction::DecReg { reg: Reg8::H }]);
const DEC_L_PROGRAM: MicroProgram = MicroProgram::new(0x2D, "DEC L", &[MicroAction::DecReg { reg: Reg8::L }]);
const DEC_A_PROGRAM: MicroProgram = MicroProgram::new(0x3D, "DEC A", &[MicroAction::DecReg { reg: Reg8::A }]);

const DEC_HL_PROGRAM: MicroProgram = MicroProgram::new(0x35, "DEC (HL)", &[MicroAction::DecHlValue]);

// === DAA ===
const DAA_PROGRAM: MicroProgram = MicroProgram::new(0x27, "DAA", &[MicroAction::ExecuteDAA]);

// === INC rr ===
const INC_BC_PROGRAM: MicroProgram = MicroProgram::new(0x03, "INC BC", &[MicroAction::IncReg16 { idx: 0 }]);
const INC_DE_PROGRAM: MicroProgram = MicroProgram::new(0x13, "INC DE", &[MicroAction::IncReg16 { idx: 1 }]);
const INC_HL_PROGRAM_16: MicroProgram = MicroProgram::new(0x23, "INC HL", &[MicroAction::IncReg16 { idx: 2 }]);
const INC_SP_PROGRAM: MicroProgram = MicroProgram::new(0x33, "INC SP", &[MicroAction::IncReg16 { idx: 3 }]);

// === DEC rr ===
const DEC_BC_PROGRAM: MicroProgram = MicroProgram::new(0x0B, "DEC BC", &[MicroAction::DecReg16 { idx: 0 }]);
const DEC_DE_PROGRAM: MicroProgram = MicroProgram::new(0x1B, "DEC DE", &[MicroAction::DecReg16 { idx: 1 }]);
const DEC_HL_PROGRAM_16: MicroProgram = MicroProgram::new(0x2B, "DEC HL", &[MicroAction::DecReg16 { idx: 2 }]);
const DEC_SP_PROGRAM: MicroProgram = MicroProgram::new(0x3B, "DEC SP", &[MicroAction::DecReg16 { idx: 3 }]);

// === ADD HL,rr ===
const ADD_HL_BC_PROGRAM: MicroProgram = MicroProgram::new(0x09, "ADD HL,BC", &[MicroAction::AddHlToReg16 { idx: 0 }]);
const ADD_HL_DE_PROGRAM: MicroProgram = MicroProgram::new(0x19, "ADD HL,DE", &[MicroAction::AddHlToReg16 { idx: 1 }]);
const ADD_HL_HL_PROGRAM: MicroProgram = MicroProgram::new(0x29, "ADD HL,HL", &[MicroAction::AddHlToReg16 { idx: 2 }]);
const ADD_HL_SP_PROGRAM: MicroProgram = MicroProgram::new(0x39, "ADD HL,SP", &[MicroAction::AddHlToReg16 { idx: 3 }]);

// === ADD SP,r8 ===
const ADD_SP_R8_PROGRAM: MicroProgram = MicroProgram::new(0xE8, "ADD SP,r8", &[MicroAction::AddSpToSignedImm8]);
